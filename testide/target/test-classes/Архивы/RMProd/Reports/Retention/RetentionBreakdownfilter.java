 ...
 * Created by Pavel
 */
public class RetentionBreakdownfilter {
    ...
    public void RetentionBreakdown() throws Exception {
        ...
        driver.get("http://registration.23traders.com/reports/retention_breakdown/");
        ...
        driver.findElement(By.xpath("//*[@id=\"left-side\"]/form/table/tbody/tr[2]/td[2]/div/ul/li[6]/a/label")).click();
