...
public class FTDFilter {
    ...
    public void NetGrossDepositfilter() throws Exception {
        driver.get("http://stage-registration.23traders.com/reports/ftd_report/");
        ...
        //Change Group by
        driver.findElement(By.xpath("//*[@id=\"left-side\"]/form/table/tbody/tr[2]/td[2]/select/option[3]")).click();
