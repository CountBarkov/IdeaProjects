...
public class LeadsAnalysisfilter {
    ...
    public void LeadsAnalysis() throws Exception {
        driver.get("http://stage-registration.23traders.com/reports/leads_analysis/");
        ...
        driver.findElement(By.xpath("//*[@id=\"left-side\"]/form/table/tbody/tr[2]/td[2]/div/ul/li[55]/a/label")).click();
